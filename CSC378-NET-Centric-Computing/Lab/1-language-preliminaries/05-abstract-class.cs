// Lab 1.5 : Write a C# program demonstrating the use of an abstract class Employee with an abstract method CalculateSalary(), implemented differently by two derived classes Manager and Clerk.
using System;
